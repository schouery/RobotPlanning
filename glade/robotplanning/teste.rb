...
class RobotplanningGlade
  ...
  def on_color_ok_clicked(widget)
    puts "on_color_ok_clicked() is not implemented yet."
  end
  def on_color_segments_activate(widget)
    puts "on_color_segments_activate() is not implemented yet."
  end
  def on_open_cancel_clicked(widget)
    puts "on_open_cancel_clicked() is not implemented yet."
  end
  def on_colors_graph_activate(widget)
    puts "on_colors_graph_activate() is not implemented yet."
  end
  def on_savedialog_file_activated(widget)
    puts "on_savedialog_file_activated() is not implemented yet."
  end
  def on_savedialog_close(widget)
    puts "on_savedialog_close() is not implemented yet."
  end
  ...
  def on_aboutdialog_close(widget)
    puts "on_aboutdialog_close() is not implemented yet."
  end
  def on_open_ok_clicked(widget)
    puts "on_open_ok_clicked() is not implemented yet."
  end
  ...
  def on_save_cancel_clicked(widget)
    puts "on_save_cancel_clicked() is not implemented yet."
  end
  ...
  def on_save_ok_clicked(widget)
    puts "on_save_ok_clicked() is not implemented yet."
  end
  def on_color_cancel_clicked(widget)
    puts "on_color_cancel_clicked() is not implemented yet."
  end
